                            ...
                            <div class="list-group" style = "border-bottom: 1px solid #DFDFDF;">
                            	...
                            	<c:forEach var = "order" items = "${orderList}">
                            		...
                            		<c:choose>
											...
											<div class = "row">
												...
												<div class = "col-9">
													<div class = "row" style = "font-size: 13px;">
														<div class = "col-1">
																<i class="fa fa-chevron-circle-down fa-lg" aria-hidden="true"
																	data-toggle="collapse" href="#orderCollapseItem7" role="button" aria-expanded="false" aria-controls="orderCollapseItem6" style = "cursor: pointer;"></i>
														</div>
														<div class = "col-sm-2">
												...
												<div class = "col-sm-3">
													<h6 class = "mb-0">
														<strong>
															Status:
															<span class = "brown-text"> Returned </strong>
													</h6>
		                                ...
		                                <div class="collapse multi-collapse" id="orderCollapseItem7" style = "border-left: 1px solid #DFDFDF; border-right: 1px solid #DFDFDF;">
											<div class = "ml-3 mr-3 mt-3 mb-2">
											...
											<div class = "row">
												...
												<div class = "col-9">
													<div class = "row" style = "font-size: 13px;">
														<div class = "col-1">
																<i class="fa fa-chevron-circle-down fa-lg" aria-hidden="true"
																	data-toggle="collapse" href="#orderCollapseItem8" role="button" aria-expanded="false" aria-controls="orderCollapseItem1" style = "cursor: pointer;"></i>
														</div>
														<div class = "col-sm-2">
															<strong> ORDER ID: </strong> <br />
																123123123
												...
												<div class = "col-sm-3">
													<h6 class = "mb-0">
														<strong>
															Status:
															<span class = "red-text"> Cancelled </strong>
													</h6>
		                                ...
		                                <div class="collapse multi-collapse" id="orderCollapseItem8" style = "border-left: 1px solid #DFDFDF; border-right: 1px solid #DFDFDF;">
											<div class = "ml-3 mr-3 mt-3 mb-2">
											...
											<div class = "row">
												...
												<div class = "col-9">
													<div class = "row" style = "font-size: 13px;">
														<div class = "col-1">
																<i class="fa fa-chevron-circle-down fa-lg" aria-hidden="true"
																	data-toggle="collapse" href="#orderCollapseItem9" role="button" aria-expanded="false" aria-controls="orderCollapseItem1" style = "cursor: pointer;"></i>
														</div>
														<div class = "col-sm-2">
															<strong> ORDER ID: </strong> <br />
																123123123
		                                ...
		                                <div class="collapse multi-collapse" id="orderCollapseItem9" style = "border-left: 1px solid #DFDFDF; border-right: 1px solid #DFDFDF;">
											<div class = "ml-3 mr-3 mt-3 mb-2">
