    ...
    <nav class="navbar navbar-expand-lg navbar-dark black">
        ...
        <div class = "container">
            ...
            <ul class="navbar-nav nav-flex-icons">
                <li class="nav-item">
                    <a class="nav-link waves-effect waves-light white-text" href="#">
        ...
        <div class = "container">
                ...
                <ul class="navbar-nav nav-flex-icons">
                    <li class="nav-item">
                        ...
                        <a class="nav-link waves-effect waves-light white-text" href="#">
                            <span class = "font-weight-bold"> Welcome kryssel!</span>
                            <img class = "ml-1" src = "user-image.jpg" height = "20" width = "20" alt = "profile image" />
                        </a>
