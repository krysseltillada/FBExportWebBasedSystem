<header class = "page-header">
    <div class="container-fluid">
        <h2 class="no-margin-bottom">Inventory > Edit product</h2>
    </div>
    </header>
            ...
            <div class = "card-body p-5">
                            ...
                            <div class="input-group">
                                <span class="input-group-btn rounded">
                                    <span class="btn btn-primary btn-file">
                                        change
                                        <i class="fa fa-file-image-o" aria-hidden="true"></i> <input type="file" id="mainProductImage">
                                    </span>
                                </span>
                ...
                <div class = "col">
                    <div class="form-group">
                        ...
                        <div class = "col-lg-4">
                            <div class="form-group m-0">
                                <img class = "mb-2 rounded" style = "border: 1px solid #DDDDDD;" id='img-upload' src = "upload-product-img.png" width = "100" height = "220" />
                                    <div class="input-group">
                                        <span class="input-group-btn rounded">
                                            <span class="btn btn-primary btn-file">
                                                change
                                                <i class="fa fa-file-image-o" aria-hidden="true"></i> <input type="file" id="previewProductImage1">
                                            </span>
                                        </span>
                                        <input type="text" class="form-control small product-image" placeholder = "image jpeg, png" readonly>
                                    </div>
                            ...
                            <div class="form-group m-0">
                                ...
                                <div class="input-group">
                                    <span class="input-group-btn rounded">
                                        <span class="btn btn-primary btn-file">
                                            change
                                            <i class="fa fa-file-image-o" aria-hidden="true"></i> <input type="file" id="previewProductImage2">
                                        </span>
                                    </span>
                                    <input type="text" class="form-control small product-image" placeholder = "image jpeg, png" readonly>
                                </div>
                            ...
                            <div class="form-group m-0">
                                ...
                                <div class="input-group">
                                    <span class="input-group-btn rounded">
                                        <span class="btn btn-primary btn-file">
                                            change
                                            <i class="fa fa-file-image-o" aria-hidden="true"></i> <input type="file" id="previewProductImage3">
                                        </span>
                                    </span>
                                    <input type="text" class="form-control small product-image" placeholder = "image jpeg, png" readonly>
                                </div>
                ...
                <div class = "col-lg">
                    ...
                    <button type="button" class="btn btn-primary float-right pl-4 pr-4">Edit</button>
                </div>
                </div>
